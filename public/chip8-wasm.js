...
var ASM_CONSTS = {
 ...
 65453: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 65546: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 65615: function() {return screen.width;},  
 65640: function() {return screen.height;},  
 65666: function() {return window.innerWidth;},  
 65696: function() {return window.innerHeight;},  
 65727: function($0) {if (typeof setWindowTitle !== 'undefined') { setWindowTitle(UTF8ToString($0)); } return 0;},  
 65822: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 65959: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
